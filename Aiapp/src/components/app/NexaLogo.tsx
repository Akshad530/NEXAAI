...
export default function NexaLogo({
  ...
  const fontSize = size === 'sm' ? 14 : size === 'md' ? 22 : 28;
  const spacing = size === 'sm' ? 6 : size === 'md' ? 12 : 16;
...
const styles = StyleSheet.create({
  ...
  hText: { flexDirection: 'row', alignItems: 'center' },
  vCol: { alignItems: 'center' },
  vText: { flexDirection: 'row', alignItems: 'center' },
  nexaText: { 
    fontWeight: '700', 
    letterSpacing: -0.5,
    fontFamily: 'System',
